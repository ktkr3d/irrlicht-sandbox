...
struct SShadowLight
{
	...
	SShadowLight(	const irr::u32 shadowMapResolution,
					...
					irr::f32 fov = 90.0 * irr::core::DEGTORAD64, bool directional = false, bool isSpot=false)
...
public:
	...
	*/
	...
	void update(const irr::u32 time, const bool screenSpaceOnly,irr::video::ITexture* outputTarget = 0,irr::scene::ISceneNode* node =0 ,irr::core::array<irr::scene::IMeshBuffer*>* buffers= 0);
...
private:
	...
	irr::s32 ShadowSS[EFT_COUNT];
	irr::s32 ShadowSSS[EFT_COUNT];
